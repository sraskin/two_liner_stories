...
(function ($) {
    ...
    $(document).ready(function(){
        ...
        //init responsive slide-right menu
		    $('#responsive-menu-button').sidr({
			    name: 'sidr-main',
			    source: '#menu',
			    onOpen: function() {
				    $('.sidr-inner a[href="'+ location.pathname +'"]').parent('li').addClass("active");
			    }
		    });
	    }

      //scroll page to start of blog
	    if (docBody.hasClass("post-template")) {
		    docBody.animate({ scrollTop: $("article").position().top }, "slow");
	    }
